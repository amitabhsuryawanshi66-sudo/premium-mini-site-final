...
8. **Use real installed skills/resources**: For visual, motion, UX, browser proof, and PR work, route through active Codex skills and plugins listed below. The legacy repo-local skill approximation folder was removed and must not be recreated or cited as operational proof.
...
- Frontend critique, shaping, polish, and UX writing: `.agents/skills/impeccable/`, but treat Impeccable as repair-pending until the preferred installer and detector proof are verified.
...
- Skill and MCP setup planning: `docs/SKILL_MCP_SETUP.md`.
...
- Skill/MCP setup: `docs/SKILL_MCP_SETUP.md`
...
## Skill File Safety
- Do not edit active installed skill directories under `.agents/skills/*` or `.codex/skills/*` during ordinary app work.
- Do not install, uninstall, delete, or rewrite skills or MCP configuration without explicit user approval for that scope.
